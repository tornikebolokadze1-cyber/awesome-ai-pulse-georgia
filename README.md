...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/repos-175-00D0FF?style=flat-square&labelColor=111827&v=18" alt="Repos"/>
...
| [Codex CLI](https://github.com/openai/codex) | 77K | OpenAI-ს ოფიციალური ტერმინალის coding agent — Rust-ში დაწერილი სიჩქარისთვის, sandbox-ში უსაფრთხოდ ასრულებს კოდს, `--approval-mode` ფლაგებით მართავ რა ნებართვები აქვს. GPT-5, o3 და სხვა OpenAI მოდელებით. **OpenAI-ის პასუხი Claude Code-ს და Cursor-ს**. ცალკე რეპო `codex-plugin-cc`-ისგან (რომელიც ასევე გვაქვს — ეს კი მთავარი CLI, ის Claude Code-ის პლაგინი). |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 72K | ავტონომიური coding agent (ყოფილი **OpenDevin**) — ქმნის, რედაქტირებს კოდს, უშვებს ბრძანებებს, ვებში ეძებს, API-ებს უძახებს. **SWE-bench-ზე ღია კოდის ლიდერი**. Docker-ში იზოლირებულად მუშაობს, ვებ UI-თ ან CLI-ით. 200+ contributor, 60+ LLM backend. Cognition AI-ის **Devin-ის პირდაპირი ღია ალტერნატივა**. |
...
| [Void](https://github.com/voideditor/void) | 28.6K | **Cursor-ის ღია ალტერნატივა** — ნულიდან აშენებული AI-native IDE. VS Code-ის ფორკი, მაგრამ სრული AI ინტეგრაცია (tab completion, agent mode, chat). 100% ღია კოდი, self-hosted LLM-ებიც (Ollama, vLLM). „Cursor = Chrome, Void = Chromium" — იგივე გამოცდილება მაგრამ საკუთარი მონაცემების სრული კონტროლით. |
| [Roo Code](https://github.com/RooCodeInc/Roo-Code) | 23.3K | **Cline-ის ყველაზე პოპულარული ფორკი** — „dev team of AI agents in your editor". რამდენიმე პარალელური აგენტი, custom modes, ადვოკატური MCP-ს მხარდაჭერა. VS Code extension, 500+ LLM provider. Cline-ზე მეტი ფუნქციური და ბევრად აქტიური განვითარებით. 1.5M+ ინსტალაცია. |
...
| რეპოზიტორია | ⭐ | აღწერა |
|---|---|---|
| [Spec Kit](https://github.com/github/spec-kit) | 90.5K | **GitHub-ის ოფიციალური Spec-Driven Development toolkit** — სპეციფიკაცია-პირველი workflow AI კოდირებისთვის. `/specify`, `/plan`, `/tasks`, `/implement` slash-commands. მხარდაჭერილი აგენტები: Claude Code, Codex CLI, Gemini CLI, Copilot, Cursor, Windsurf, Qwen Code. AI-ს აიძულებს ჯერ გეგმა შექმნას, მერე დაიწყოს კოდირება. GSD-ისა და Superpowers-ის პირდაპირი კონკურენტი **GitHub-ის ოფიციალური ბრენდით**. |
| [Claude Flow](https://github.com/ruvnet/claude-flow) | 33K | **#1 Claude Code multi-agent ორკესტრატორი** — „distributed swarm intelligence", RAG ინტეგრაცია, enterprise-დონის არქიტექტურა. native Claude Code + Codex ინტეგრაცია. Oh My ClaudeCode-ის (რომელიც გვაქვს) მთავარი კონკურენტი, უფრო დიდი audience-ით. autonomous workflows, conversational AI systems-ის ასაშენებლად. |
...
| [Karpathy Skills](https://github.com/forrestchang/andrej-karpathy-skills) | 49K | Andrej Karpathy-ს ფილოსოფიიდან შექმნილი Claude Code-ის კონფიგურაცია — LLM-ის ტიპური შეცდომებისგან (ჰალუცინაციები, ცუდი დებაგი, ზედმეტი რეფაქტორინგი) იცავს AI-ს. 2026 აპრილში ერთ დღეში 9,263 ვარსკვლავი მიიღო, 48 საათი #1 იყო GitHub Trending-ზე. Claude Code-ის ხარისხის გაუმჯობესების ერთ-ერთი საუკეთესო ხელსაწყო. |
...
| [FastMCP](https://github.com/jlowin/fastmcp) | 25K | **#1 Python MCP server ფრეიმვორკი** — „FastAPI for MCP". decorators-ით ადვილად წერ MCP სერვერებს, Anthropic-ის ოფიციალური MCP Python SDK-ის საფუძვლად გახდა. MCP კლიენტებიც შიგნითვეა. **თუ MCP სერვერი გინდა დაწერო, ამით იწყე**. Jeremiah Lowin-ის (Prefect-ის CEO) შექმნილი. |
| [Serena](https://github.com/oraios/serena) | 23.3K | **Semantic code editing MCP toolkit** — Language Server Protocol-ის (LSP) ქვეშ სარგებლობს, AI-ს აძლევს კოდის **სემანტიკურ** (არა ტექსტუალურ) რედაქტირების უნარს. „IDE for your agent" — Cursor-ის უფასო ალტერნატივა ნებისმიერი coding agent-ისთვის. symbols, references, definitions-ის პირდაპირი წვდომა — 10x სიზუსტე უბრალო grep-თან შედარებით. |
...
| რეპოზიტორია | ⭐ | აღწერა |
|---|---|---|
| [Firecrawl](https://github.com/mendableai/firecrawl) | 112K | **AI-ფოკუსით web scraping API** — URL → სუფთა Markdown/JSON LLM-ებისთვის. scrape, crawl, search, extract ოპერაციები ერთ API-ში. JavaScript რენდერი, anti-bot გვერდის ავლა, structured data extraction. Mendable AI-ის (YC S23) ფლაგმანი პროდუქტი. **ამ კატეგორიის #1 რეპო 112K ვარსკვლავით** — თუ AI-ს ვებგვერდებიდან მონაცემები უნდა გადასცე, აქ იწყება. TypeScript + Python SDK-ები, self-hosted ან cloud. |
| [Browser Use](https://github.com/browser-use/browser-use) | 86K | AI აგენტს ნამდვილი ბრაუზერის გამოყენების უნარს აძლევს — შეუძლია ღილაკებზე დაჭერა, ტექსტის შეყვანა, გვერდებზე ნავიგაცია და მონაცემების ამოღება ისევე, როგორც ადამიანი მუშაობს ბრაუზერში. |
| [Crawl4AI](https://github.com/unclecode/crawl4ai) | 64.5K | AI-ოპტიმიზებული ღია web crawler/scraper — 6x სწრაფი Scrapy-ზე, semantic chunking, JavaScript რენდერი. **clean Markdown output** LLM-ებისთვის. 100% ღია, 100% უფასო, ლოკალურად გაშვებადი — Firecrawl-ის ალტერნატივა API-ის გარეშე, შენს კომპიუტერზე. ქართული RAG pipeline-ებისთვის — ვებიდან უყოყმანოდ მოპოვების საუკეთესო ფრეიმვორკი. |
| [Stagehand](https://github.com/browserbase/stagehand) | 22.3K | „The SDK For Browser Agents" — Playwright-ის AI-პირველი ალტერნატივა. ბუნებრივი ენის ბრძანებებით ვებ automation (`page.act("click login")`, `page.extract("get price")`). **natural language + code** hybrid — უფრო სტაბილური და AI-friendly ვიდრე სუფთა Playwright. Browserbase-ის (YC W24) პროდუქტი. TypeScript + Python. |
...
| რეპოზიტორია | ⭐ | აღწერა |
|---|---|---|
| [LangChain](https://github.com/langchain-ai/langchain) | 135K | **LLM აპლიკაციების ფუნდამენტური ფრეიმვორკი** — chains, prompts, tools, agents, memory, document loaders, 700+ ინტეგრაცია. LangGraph-ის (რომელიც გვაქვს) მშობელი ფრეიმვორკი. Python და JavaScript/TypeScript. Harrison Chase-ის შექმნილი 2022-ში — **AI აგენტების ერის დაწყება**. ყველა მომდევნო framework (CrewAI, AutoGen, LangGraph) LangChain-ის პრიმიტივებზეა აშენებული. |
...
| [MetaGPT](https://github.com/geekan/MetaGPT) | 67K | „პირველი AI Software Company" — მრავალაგენტური ფრეიმვორკი, სადაც AI აგენტები Product Manager, Architect, Engineer, QA როლებში **ერთობლივად ქმნიან** პროგრამულ პროდუქტს. ერთი prompt-იდან → სრული კოდბაზა: PRD → design doc → code → tests. AutoGen-ისა და CrewAI-ს მთავარი კონკურენტი, ჩინური research გუნდის შექმნილი. |
| [DSPy](https://github.com/stanfordnlp/dspy) | 34K | Stanford NLP-ს **„programming, not prompting"** — LLM აპლიკაციის კოდს გარდაქმნის საკომპილირებელ სტრუქტურად. შენ განსაზღვრავ მიზანს (signature), DSPy ავტომატურად ოპტიმიზებს prompt-ებს და few-shot examples-ს. **აკადემიური რევოლუცია** — ADC-style mono-system-ებიდან declarative multi-LM pipelines-ზე გადასვლა. NeurIPS/EMNLP papers-ით დამტკიცებული. |
| [agno](https://github.com/agno-agi/agno) | 39.6K | **Production agent framework** (ყოფილი phidata) — agents, workflows, memory, tools, knowledge bases, monitoring. multi-agent teams, session state. Python-ში, light-weight (მინიმალური dependencies). AI Hedge Fund-ის (რომელიც გვაქვს) საფუძველი. phidata-დან rebrand-ი agno-ზე 2025-ში. ფოკუსი scale-ზე — production deployments. |
| [smolagents](https://github.com/huggingface/smolagents) | 26.8K | 🤗 **Hugging Face-ის barebones library for agents** — აგენტები, რომლებიც კოდით ფიქრობენ (არა JSON-ით). ToolCallingAgent + CodeAgent. 2k ხაზი კოდი, 100+ მოდელი (HF + OpenAI + Anthropic + Ollama). minimalistic — თუ Pydantic AI-ზე უფრო მარტივი გინდა. |
| [Swarm](https://github.com/openai/swarm) | 21.4K | **OpenAI-ს educational multi-agent framework** — agents + handoffs პრინციპით (routines). archived status მაგრამ საფუძვლად დაედო openai-agents-python-ს (რომელიც გვაქვს). **სასწავლო რესურსი** — სიმარტივის ფილოსოფია multi-agent orchestration-ში. OpenAI Solution Team. |
| [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) | 55.6K | AI საინვესტიციო ფონდის სიმულაცია — Warren Buffett, Charlie Munger, Michael Burry-ს სტილის AI აგენტები ერთად აანალიზებენ აქციებს და ღებულობენ გადაწყვეტილებებს. LangGraph-ზე აშენებული, მრავალაგენტური რეალური რეზონინგის საუკეთესო მაგალითი. 2026 აპრილში მე-10 ადგილი GitHub Trending Daily-ზე. |
...
| [Kronos](https://github.com/shiyu-coder/Kronos) | 18.7K | ფინანსური ბაზრების სპეციალიზებული AI მოდელი — K-line (ქენდლსტიქ) პატერნებზე ნატრენინგები, არა უბრალოდ ტექსტზე. AAAI 2026-ზე მიღებული აკადემიური ნაშრომი. პირველი LLM, რომელიც სპეციალურად ფინანსური ბაზრებისთვის არის აშენებული — დომენ-სპეციფიკური AI-ის მომავლის ერთ-ერთი ნიმუში. |
...
| რეპოზიტორია | ⭐ | აღწერა |
|---|---|---|
| [n8n](https://github.com/n8n-io/n8n) | 185K | **THE workflow automation platform** — ვიზუალური no-code builder 400+ ინტეგრაციით (Gmail, Slack, Airtable, ყველა მთავარი ღრუბელი, AI პროვაიდერი). self-hosted ან cloud, fair-code ლიცენზია. **დედამიწის #1 ავტომატიზაციის ხელსაწყო** AI აგენტებისა და ბიზნეს სისტემების დასაკავშირებლად — Zapier-ის ღია ალტერნატივა. AI Pulse Georgia-ს მთავარი infrastructure stack-ის ნაწილი — aipulsegeorgia2025.app.n8n.cloud. |
...
| [gpt4all](https://github.com/nomic-ai/gpt4all) | 77K | Nomic AI-ის ღია ხელსაწყო **local LLM-ების ნებისმიერ მოწყობილობაზე გასაშვებად** — Mac, Windows, Linux. GPU არ სჭირდება. desktop აპი + Python/Node SDK + REST API. კომერციული გამოყენებაც ნებადართული. Ollama-ს კონკურენტი — მეტი GUI ფოკუსით. 77K ვარსკვლავი ლოკალური AI-ის მოძრაობის საფუძველი. |
| [LobeChat](https://github.com/lobehub/lobe-chat) | 75.5K | **ChatGPT-ის ღია ალტერნატივა #1** — ნებისმიერი LLM-ის სერვერი (OpenAI, Claude, Gemini, Ollama), multi-agent collaboration, plugin marketplace, voice chat, document analysis. თქვენი **საკუთარი ChatGPT-ის კლონი**, self-hosted, privacy-first. TypeScript + Next.js. გვერდი ასობით hosted version-ს აქვს მთელ მსოფლიოში. |
| [AnythingLLM](https://github.com/Mintplex-Labs/anything-llm) | 59K | All-in-one AI პროდუქტიულობის პლატფორმა — **RAG (დოკუმენტები → AI), agents, chat, API** ერთ აპში. desktop + server ვერსიები, multi-user, 20+ LLM provider. **სრულად პრივატული და self-hosted** — შენი დოკუმენტები შენს კომპიუტერზე რჩება. Mintplex Labs-ის შექმნილი — ქართული ბიზნესისთვის, რომელიც მონაცემების კონფიდენციალობას ამჯობინებს, იდეალური არჩევანი. |
| [Flowise](https://github.com/FlowiseAI/Flowise) | 52K | „Build AI Agents, Visually" — drag-and-drop ვიზუალური LLM app builder. node-based ინტერფეისი LangChain.js-ის კომპონენტებით — chains, agents, vector stores, LLM-ები დააკავშირე ერთმანეთთან. **Langflow-ის Node.js ალტერნატივა** (Langflow = Python, Flowise = JS). 100+ ინტეგრაცია, ღია კოდი. non-technical users-იც შეძლებენ AI აგენტების აწყობას. |
| [Jan](https://github.com/janhq/jan) | 42K | **ChatGPT offline ალტერნატივა desktop აპლიკაციად** — 100% ოფლაინ მუშაობს თქვენს კომპიუტერზე. Mac/Windows/Linux native app, Cortex backend-ით. Llama, Mistral, Phi, Qwen — ერთი click-ით ჩატვირთვა. **privacy-first alternative** — თქვენი საუბრები არასდროს ტოვებს მოწყობილობას. Ollama-ს GUI-ფოკუსიანი ალტერნატივა. |
| [LibreChat](https://github.com/danny-avila/LibreChat) | 35.9K | **Enhanced ChatGPT clone** — ყველა ფრონტიერი LLM ერთ ინტერფეისში: Claude, GPT-5, o3, DeepSeek, Gemini, Mistral, Groq, Anthropic Bedrock, Azure OpenAI, OpenRouter, Vertex AI. DALL-E-3, Code Interpreter, message search, secure multi-user auth, presets, OpenAPI Actions. **self-hosted** — კომპანიისთვის იდეალური, რომ ერთ ადგილას ჰქონდეთ ყველა AI მოდელი. |
| [Khoj](https://github.com/khoj-ai/khoj) | 34.2K | **„Your AI second brain"** — self-hostable personal AI, რომელიც შენს დოკუმენტებს, ვებს, iMessage-ებს და Notion-ს ეძებს. custom agents, scheduled automations, deep research მოდი. turn ნებისმიერი online ან local LLM (GPT, Claude, Gemini, Llama, Qwen, Mistral) → პერსონალურ ავტონომიურ AI-ად. უფასო ვერსია პოპულარულია. |
| [Activepieces](https://github.com/activepieces/activepieces) | 21.8K | **n8n-ის ღია ალტერნატივა AI-first ფოკუსით** — 400+ MCP სერვერი AI აგენტებისთვის, AI workflow automation. TypeScript-ში დაწერილი. self-hosted ან cloud. თუ n8n-ი მოგწონს, მაგრამ ახალი AI-native ალტერნატივა გინდა, ეს არის საუკეთესო. |
...
| [DeepTutor](https://github.com/HKUDS/DeepTutor) | 18.7K | აგენტ-native პერსონალიზებული სასწავლო ასისტენტი — RAG, ვებ ძიება, სამეცნიერო ნაშრომების ძიება, კოდის ექსეკუცია ერთ პლატფორმაზე. 5 რეჟიმი: Chat, Deep Solve, Quiz Generation, Deep Research, Math Animator. მდგრადი TutorBot-ები მეხსიერებითა და პიროვნებით. |
| [Multica](https://github.com/multica-ai/multica) | 14.5K | ღია კოდის managed agents პლატფორმა — AI აგენტები ნამდვილ გუნდის წევრებად აქცევს. მიანიჭე ამოცანები, აკონტროლე პროგრესი, შეაგროვე უნარები. მუშაობს Claude Code-თან, Codex-თან, OpenClaw-თან. 2 კვირაში 4K-დან 14K ვარსკვლავამდე გაიზარდა. Anthropic-ის Claude Managed Agents-ის ღია ალტერნატივა. |
| [Rowboat](https://github.com/rowboatlabs/rowboat) | 12.5K | ღია კოდის AI „თანამშრომელი" მდგრადი მეხსიერებით — ელ-ფოსტასთან, შეხვედრებთან დაკავშირება, ცოდნის გრაფების შექმნა, ამოცანების ავტომატიზაცია ლოკალურად (ღრუბელი არ სჭირდება). შენი სამუშაო ცხოვრებას ცოცხალ ცოდნის ბაზად აქცევს, Markdown-ში შენახული. Privacy-first AI ასისტენტი. |
...
| [Milvus](https://github.com/milvus-io/milvus) | 44K | **#1 cloud-native ვექტორული DB** — scalable vector ANN search, მილიარდობით ვექტორისთვის. Rust + Go, distributed architecture, Kubernetes-ready. LF AI Foundation-ის პროექტი. enterprise deployments (NVIDIA, Roblox, Shopee, Salesforce). თუ RAG-ი scale-ზე გჭირდება, ეს არის სტანდარტი. |
| [Qdrant](https://github.com/qdrant/qdrant) | 30.6K | **Rust-ში დაწერილი high-performance ვექტორული DB** — cloud-native, horizontal scaling, filtering payload-ით, quantization. ძალიან სწრაფია (Rust-ის გამო), Docker-ით ადვილად გაუშვებ. მცირე და საშუალო RAG deployments-ისთვის Milvus-ის ალტერნატივა. Python/JS/Go SDK. |
...
| [Chroma](https://github.com/chroma-core/chroma) | 27.6K | **ვექტორული DB #1 Python-ში** — embeddings-ის შენახვა/ძიება. LangChain-ის default, LlamaIndex-ის default. embedded (SQLite-ზე), standalone ან cloud. ძალიან მარტივი API — 5 ხაზით RAG-ი აიწყობა. Series A funding, YC W23. თუ RAG აპლიკაცია გინდა, ყველაზე სწრაფი გზა. |
| [Letta](https://github.com/letta-ai/letta) | 22.2K | **Stateful agents პლატფორმა** (ყოფილი MemGPT) — AI-ს აქვს hierarchical memory: working memory (short-term) + archival memory (long-term). აგენტი დროთა განმავლობაში „სწავლობს" და იხსენებს თქვენი საუბრების დეტალებს. UC Berkeley-ს research → startup. OpenAI-ს API-თავსებადი REST API, self-hosted. long-running agents-ისთვის იდეალური — weeks/months-ის მეხსიერება. |
...
| [whisper.cpp](https://github.com/ggerganov/whisper.cpp) | 49K | **OpenAI Whisper-ის C++ port** — აუდიო → ტექსტი 100+ ენაზე (ქართული ჩათვლით), ნებისმიერ მოწყობილობაზე. GPU არ სჭირდება, ბატარეული ტელეფონიც კი უმკლავდება. Georgi Gerganov-ის (llama.cpp-ის შემქმნელი) შედევრი. real-time transcription, streaming, speaker diarization. ქართული podcast-ებისა და ინტერვიუების transcription-ისთვის — სტანდარტული ინსტრუმენტი. |
| [LocalAI](https://github.com/mudler/LocalAI) | 45.7K | **„OpenAI-compatible API ღია მოდელებისთვის"** — ერთი ბრძანება და გაქვს ChatGPT-ს მსგავსი API ლოკალურად, GPU-ს გარეშე. LLMs, vision, voice (TTS/STT), image, video — ერთ სერვერში. OpenAI-ის SDK-ები ცვლილების გარეშე მუშაობს (swap base URL). self-hosted AI-ს #1 infrastructure. |
| [Bark](https://github.com/suno-ai/bark) | 39K | **Suno AI-ის generative audio model** — ტექსტიდან realistic multilingual speech, music, sounds, effects. არა მხოლოდ speech — **პირველი open-source text-to-audio** ემოციებით, laugh/cry/sigh ეფექტებით. 100+ ენა. Coqui TTS-ის ალტერნატივა მეტი მრავალფეროვნებით. |
| [Diffusers](https://github.com/huggingface/diffusers) | 33.4K | 🤗 **Hugging Face-ის state-of-the-art diffusion models** — Stable Diffusion, FLUX, SDXL, CogVideoX, video generation. image + video + audio generation. Transformers-ის „diffusion counterpart". **თუ Python-ში AI ხელოვნებას აკეთებ, ამით იწყებ**. LoRA, ControlNet, IP-Adapter — ყველა პოპულარული ტექნიკა. |
| [FLUX](https://github.com/black-forest-labs/flux) | 25.5K | **Black Forest Labs-ის FLUX.1 model family** — Stable Diffusion-ის შემქმნელი გუნდის ახალი image generation მოდელი. FLUX.1 [dev] და [schnell] ღიად ხელმისაწვდომი. **2024 წლის #1 ღია image model** — ვიდეო gen-ისთვისაც ფუნდამენტი (Kling, CogVideoX იყენებს). |
...
| რეპოზიტორია | ⭐ | აღწერა |
|---|---|---|
| [Build Your Own X](https://github.com/codecrafters-io/build-your-own-x) | 494K | **GitHub-ის #2 ყველაზე ვარსკვლავიანი რეპო საერთოდ** — ააშენე საკუთარი ნებისმიერი ტექნოლოგია ნულიდან: Git, Docker, blockchain, database, operating system, programming language, **LLM**, neural network, game engine, web server. ათასობით tutorial კატეგორიზებული მითითებებით. **პროგრამისტობის სიღრმეში ჩასახედად #1 რესურსი**. |
...
| [System Prompts Collection](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 136K | **სრული leaked system prompts** — Claude Code, Cursor, Devin AI, v0, Lovable, Replit, Windsurf, Cluely, Warp, Xcode, Perplexity, Bolt, Trae, Kiro, Same.dev, Manus, NotionAI, Z.ai Code, Augment Code — **25+ AI ხელსაწყოს შინაგანი prompt-ები**. Prompt engineering-ის **Rosetta Stone** — როგორ წერენ ფრონტიერ კომპანიები system prompt-ებს. აუცილებელი რესურსი, თუ AI აგენტებს აწყობ ან prompt engineering-ს სწავლობ. |
| [LLMs from Scratch](https://github.com/rasbt/LLMs-from-scratch) | 91K | Sebastian Raschka-ს **#1 deep learning წიგნი** — ააშენე ChatGPT-ს მსგავსი LLM PyTorch-ში, ნაბიჯ-ნაბიჯ, ნულიდან. attention mechanism, tokenization, training, fine-tuning, RLHF. **თუ გინდა გაიგო როგორ მუშაობს AI შიდა მექანიკით**, ეს არის მთავარი რესურსი. Jupyter notebooks + Manning-ის წიგნი (ბესტსელერი). 91K ვარსკვლავი — AI განათლების #1 რესურსი მსოფლიოში. |
...
| [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) | 41K | **Anthropic-ის ოფიციალური recipes/examples Claude-ისთვის** — tool use, prompt caching, agentic workflows, vision, JSON mode, PDFs, computer use, extended thinking, batch API. თუ Claude API-ს იყენებ, **აქედან დაიწყე**. Jupyter notebooks, პრაქტიკული code snippets. ქართული პროექტებისთვის — საუკეთესო სასწავლო მასალა Claude-ის შესაძლებლობებზე. |
